...
from fastapi import FastAPI, HTTPException, Depends  # Импортируем FastAPI и исключения, а также Depends для внедрения зависимостей
...
from sqlalchemy.ext.asyncio import (create_async_engine,
    async_sessionmaker, AsyncSession)  # Импортируем асинхронные функции SQLAlchemy
